...
$string['dashlearner:addinstance'] = 'Add a new LAD block';
$string['dashlearner:bemonitored'] = 'Usuário é monitorado na disciplina';
$string['dashlearner:myaddinstance'] = 'Add a new LAD block to the My Moodle page';
$string['dashleaner:viewpages'] = 'Visualiza gráficos';
$string['pluginname'] = 'Dashboard Learner';
$string['dashlearner'] = 'Dashboard Learner';

$string['radar'] = 'Performance Analysis';
$string['modulos'] = 'Submission Analysis';
$string['acessos'] = 'Submission Accesses ';
$string['notas'] = 'Grades Graphics';
...
$string['msgNotas'] = 'Table with the grades obtained by the student (Eu) and the average grade of the students (Grupo) for each activity';
...
$string['note_frame'] = 'Performance Analysis';
